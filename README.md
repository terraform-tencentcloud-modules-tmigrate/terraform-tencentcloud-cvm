...
| data_disk_count            | Data disk count, CVM module attach disk by CBS. pass `0` will not create CBS instance.                                                                                                                                                                                                                                                                                                                                                                           | number        | 0                |    no    |
...
| data_disk_size             | Size of the data disk, and unit is GB.                                                                                                                                                                                                                                                                                                                                                                                                                           | number        | null             |    no    |
